...
<page:template>
    <jsp:attribute name="title">Аккаунт | Bookshop</jsp:attribute>
    <jsp:body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <form:form action="account" method="post" modelAttribute="customer">
                                ...
                                <div class="customar__field">
                                    <div class="margin_between">
                                        <div class="input_box space_between">
                                            ...
                                            <form:input type="text" path="firstname" disabled="true"/>
                                        </div>
                                        <div class="input_box space_between">
                                            <label>Фамилия<span>*</span></label>
                                            <form:input type="text" path="lastname" disabled="true"/>
                                        </div>
                                    </div>
                                    <div class="margin_between">
                                        <div class="input_box space_between">
                                    ...
                                    <div class="input_box">
                                        <label>Страна</label>
                                        <form:select class="select__option" path="country" disabled="true">
                                    ...
                                    <div class="input_box">
                                        <label>Регион</label>
                                        <form:select class="select__option" path="state" disabled="true">
                                    ...
                                    <div class="margin_between">
                                        <div class="input_box space_between">
                                            <label>Город</label>
                                            <form:input type="text" path="city" disabled="true"/>
                                        </div>
                                        <div class="input_box space_between">
                                            <label>Индекс</label>
                                            <form:input type="text" path="postal" disabled="true"/>
                                        </div>
                                    </div>
                                    <div class="input_box">
                                        <label>Адрес</label>
                                        <form:input type="text" path="street" placeholder="Улица" disabled="true"/>
                                    </div>
                                    <div class="input_box">
                                        <form:input type="text" path="address" placeholder="Дом, строение, квартира, подъезд, этаж" disabled="true"/>
                                    </div>
                                    ...
                                    <div class="form__btn">
                                        ...
                                        <script>
                                            function editForm(f) {
                                                f.firstname.disabled = 0;
                                                f.lastname.disabled = 0;
                                                f.email.disabled = 0;
                                                f.phone.disabled = 0;
                                                f.country.disabled = 0;
                                                f.state.disabled = 0;
                                                f.city.disabled = 0;
                                                f.postal.disabled = 0;
                                                f.street.disabled = 0;
                                                f.address.disabled = 0;
                                                f.editButton.hidden = 1;
                                                f.submit.hidden = 0;
                                            }
                                        </script>
                                        ...
                                        <form:button type="button" name="editButton" onclick="editForm(this.form)">Редактировать</form:button>
                                        <form:button type="submit" name="submit" hidden="true">Сохранить</form:button>
                                    </div>
                                </div>
                            </div>
                        </form:form>
