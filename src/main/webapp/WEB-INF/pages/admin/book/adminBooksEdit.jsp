...
<page:template>
    <jsp:attribute name="title">Редактирование книги | Bookshop</jsp:attribute>
    <jsp:body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <form:form action="adminBookSave" method="post" modelAttribute="editBook" enctype="multipart/form-data">
                            <form:input path="isbn" hidden="true"/>
                            ...
                            <div class="customer_details">
                                ...
                                <div class="customar__field">
                                    <div class="input_box">
                                        ...
                                        <img id="blah_original" src="resources/images/product/books-img/${editBook.isbn}.jpg" height="320"/>
